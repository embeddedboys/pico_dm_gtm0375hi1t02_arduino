...
#define TFT_BL   28            // LED back-light control pin
...
#define TFT_D1   1  // so a single register write sets/clears all bits.
#define TFT_D2   2  // Pins can be randomly assigned, this does not affect
#define TFT_D3   3  // TFT screen update performance.
#define TFT_D4   4
#define TFT_D5   5
#define TFT_D6   6
#define TFT_D7   7
